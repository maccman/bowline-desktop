...
@interface MyScriptDelegate : NSObject
{
    wxWebKitCtrl* webKitWindow;
    WebFrame *frame;
}

- initWithWxWindow: (wxWebKitCtrl*)inWindow forFrame: (WebFrame *)frame;
...
- (void)webView:(WebView *)webView didClearWindowObject:(WebScriptObject *)windowScriptObject forFrame:(WebFrame *)frame {
  MyScriptDelegate* myScriptDelegate = [[MyScriptDelegate alloc] initWithWxWindow: webKitWindow forFrame: frame];
  [windowScriptObject setValue:myScriptDelegate forKey:@"wx"];
}
@end
...
@implementation MyScriptDelegate

- initWithWxWindow: (wxWebKitCtrl*)inWindow forFrame:(WebFrame *)inFrame
{
    [super init];
    webKitWindow = inWindow;
    frame = inFrame;
